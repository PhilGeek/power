...
Sight is for the sake of seeing. That thought animates the tragedy that befalls Claudia Menlo, played by Joan Crawford, in a segment of the first episode of \emph{The Night Gallery} entitled ``Eyes''. Claudia Menlo is a wealthy blind woman who undergoes an experimental eye transplant, with eyes illegaly purchased from an impoverished gambler. The effects of the procedure are brief, Claudia will be able to see for only a few hours. To make the most of this fleeting capacity for sight, Claudia has filled her apartment with great works of art. However, alone in her apartment, after the surgery, but before her bandages are removed, a black out occurs, and her sight only persists until first light. Her fate is tragic insofar as her sight, acquired by sacrificing the humanity in another, is wasted. But this could only be so if sight is for the sake of seeing.

Reflection on this, provides us with the basis of an argument for experiential pluralism. Let sense experience be the genus of which perception is a species. Cambridge realists such as \citet{Russell:1912uq} and \citet{Price:1932fk} maintained that \emph{all} sense experience, and not just perception, involves a non-propositional mode of sensory awareness. Cambridge realists were thus committed to a kind of \emph{experiential monism} (in Snowdon's \citeyear{Snowdon:2008oz} terminology). Specifically, all sense experience involves, as part of its nature, a non-propositional mode of sensory awareness. Even subject to illusion or hallucination, there is something of which one is aware. And with that, they were an application of the argument from illusion, or hallucination, or conflicting appearances away from immaterial sense data and a representative realism that tended, over time, to devolve into a form of phenomenalism. Drawing on the distinct tradition of Oxford realism, the disjunctivism defended by Travis, in contrast, is a kind of \emph{experiential pluralism}. Perception may be a mode of sensory awareness, but not all sense experience, involves, as part of its nature, a non-propositional mode of sensory awareness.
...
\section{Ontological Dependence and Experiential Pluralism} % (fold)
