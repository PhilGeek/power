...
Knowledge is factive. If a subject knows something, there is some fact that the subject knows. Correspondingly, if a subject sees something, there is some object that the subject sees. If there is no object that the subject sees, then the subject fails to see anything. Undergoing an episode of seeing is a way for a subject to be and part of what it is to be that way is for there to be something that is the object of perception. So the end of sight, that for the sake of which the subject possesses that capacity, essentially involves there being something which is seen.
