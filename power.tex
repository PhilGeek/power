...
\]
Let `\( P \)' be the sentence `A subject sees something'. Given that this perceptual capacity just is the subject's potential to see something, the attribution of this capacity is represented as `\( \Diamond P \)'. But so interpreted, this is just the existential dependence of the exercise of a capacity upon the capacity whose exercise it is. This follows from:
\begin{enumerate}
